...
namespace JDoddsNAIT.ObjectDetection
{
    ...
    public class Condition
    {
        ...
        enum Invert { [InspectorName("IS")] False = 0, [InspectorName("NOT")] True = 1 }
        ...
        public string GetCurrentConditionName(out Evaluation evaluation)
        {
            Tuple<string, Evaluation> result = CurrentCondition switch
            {
                ...
                //Conditions.Types.HasScript => new(nameof(HasScript), HasScript),
                Conditions.Types.InLineOfSight => new(nameof(InLineOfSight), InLineOfSight),
        ...
        //[SerializeField] private Conditions.HasScript HasScript;
        [SerializeField] private Conditions.InLineOfSight InLineOfSight;
    }
}